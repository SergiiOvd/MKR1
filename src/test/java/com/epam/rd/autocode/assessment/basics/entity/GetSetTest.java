...
public class GetSetTest {
    ...
    void testBook() {
        com.epam.rd.autocode.assestment.basics.entity.GetSetVerifier verifier = new com.epam.rd.autocode.assestment.basics.entity.GetSetVerifier(Book.class);
    ...
    enum AgeGroup {
        CHILDREN, TEEN, ADULT, SENIOR, CHILD;

        // No need for getters and setters for enum constants
    }

    // Language enum
    enum Language {
        ENGLISH, SPANISH, FRENCH, GERMAN, OTHER, JAPANESE;
